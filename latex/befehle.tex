...
%
% \needspace{...} reserviert vor dem Aufgabenblock Mindestplatz, sodass
% LaTeX bei knappen Verhältnissen lieber vorher umbricht — sonst
% landete die Marginalie auf der vorigen Seite, während der
% zugehörige Block erst auf der nächsten Seite begann (LY-01).
