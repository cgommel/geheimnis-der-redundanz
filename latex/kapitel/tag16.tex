...
Das Skript verwendet \texttt{matplotlib} und speichert das Ergebnis
als \texttt{.pdf} — damit bleibt das Diagramm bei jeder Zoomstufe
scharf (Vektorgrafik, kein Pixelmatsch beim Druck). Eine senkrechte
rote Linie markiert die theoretische RS-Grenze.
\end{pythoneinheit}
