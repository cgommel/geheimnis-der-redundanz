...
Bewusst kein \texttt{matplotlib} — das Skript schreibt direkt einen
\texttt{tikzpicture}-Block in eine \texttt{.tex}-Datei. Damit wird
das Diagramm im Buch als Vektorgrafik gesetzt (jede Zoomstufe scharf,
kein Pixelmatsch beim Druck) — und gleichzeitig konsistent zu
allen anderen TikZ-Diagrammen, die du auf dem Weg gesehen hast.
Eine senkrechte rote Linie markiert die theoretische RS-Grenze.
\end{pythoneinheit}
...
\begin{center}
\input{abbildungen/tag16/fehler_demo_diagramm.tex}
\end{center}
