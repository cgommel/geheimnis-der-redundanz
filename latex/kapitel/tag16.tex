...
Bewusst kein \texttt{matplotlib} — wir bleiben bei Pillow. Achsen,
Gitter und ein Linienzug sind in 30 Zeilen handgemalt. Auf eine rote
senkrechte Linie kommt die theoretische RS-Grenze.
\end{pythoneinheit}
...
\begin{center}
\includegraphics[width=0.92\linewidth]{abbildungen/tag16/fehler_demo_diagramm.png}
\end{center}
