...
\begin{itemize}
\item \textbf{Alle Syndrome sind 0:} entweder ist alles gut, oder
  die Fehler sind so groß, dass das Codewort „zufällig“ zu einem
  anderen gültigen Codewort wurde (extrem unwahrscheinlich).
\item \textbf{Mindestens ein Syndrom $\ne 0$:} es gab Fehler.
  Wir wissen aber noch nicht, wie viele und wo.
\end{itemize}
...
\subsection*{Vorschau Tag 9 — Einen Strichcode von Hand zeichnen}

Die letzten zwei Tage haben wir mit Reed-Solomon-Mathematik
verbracht. Bevor wir uns an einen Datamatrix-Code wagen, machen wir
einen Schritt zurück und zeichnen einen \textbf{EAN-13-Strichcode von
Hand} — den Strichcode-Typ kennst du schon aus Tag 1. Du wählst zwölf
Ziffern (zum Beispiel dein Geburtsdatum), berechnest die Prüfziffer,
übersetzt jede Ziffer in ihr Strichmuster und füllst eine
Zeichenvorlage Modul für Modul aus. Anschließend ausdrucken und mit
dem Handy scannen. Das ist die Generalprobe für das eigentliche Ziel
— einen Datamatrix-Code mit deinem Namen drauf, weiter hinten im Buch.
